      ...
      <div className="max-w-[1200px] mx-auto flex flex-col gap-6">
        <header className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-gray-500 text-xs md:text-sm">Controle de saldo e histórico de compras.</p>
          </div>
          <button 
                  ...
                  return (
                    <tr key={c.id} className="hover:bg-pink-50/10 transition-colors group">
                      ...
                      <td className="px-6 py-4 text-right opacity-0 group-hover:opacity-100 transition-opacity">
                        <button className="text-gray-400 hover:text-[#ee2b6c] mx-2"><span className="material-symbols-outlined text-xl">edit</span></button>
                        <button className="text-gray-400 hover:text-[#4a1d96] mx-2"><span className="material-symbols-outlined text-xl">visibility</span></button>
                      </td>
                    </tr>
                  );
                })}
